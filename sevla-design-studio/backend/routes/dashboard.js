...
router.route('/update/:ProductName').put(async (req, res) => {
    ...
    try {
        ...
        Product.updateOne({ ProductName: req.params['ProductName'] }, { $set: { ProductName: ProductName, ProductDescription: ProductDescription, 
            ProductLongDescription: ProductLongDescription, ProductPrice: ProductPrice, ProductSize: ProductSize, ProductType: ProductType, 
            ProductQuantity: ProductQuantity, ProductImg: [ProductImg] } })
